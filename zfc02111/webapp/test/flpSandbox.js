		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Create Entity Prac",
									"targetURL": "#sync04zfc02111-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync04zfc02111-display": {
								"semanticObject": "sync04zfc02111",
								"action": "display",
								"description": "Create Entity Prac",
								"title": "Create Entity Prac",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync04.zfc02111",
									"url": sap.ui.require.toUrl("sync04/zfc02111")
								}
							}
						}
					}

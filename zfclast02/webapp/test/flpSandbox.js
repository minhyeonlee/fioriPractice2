		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "항공사별 매출집계",
									"targetURL": "#sync04zfclast02-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync04zfclast02-display": {
								"semanticObject": "sync04zfclast02",
								"action": "display",
								"description": "[S4-02] Fiori Exam",
								"title": "항공사별 매출집계",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync04.zfclast02",
									"url": sap.ui.require.toUrl("sync04/zfclast02")
								}
							}
						}
					}

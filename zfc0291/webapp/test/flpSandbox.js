		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Single Entity",
									"targetURL": "#sync04zfc0291-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync04zfc0291-display": {
								"semanticObject": "sync04zfc0291",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync04.zfc0291",
									"url": sap.ui.require.toUrl("sync04/zfc0291")
								}
							}
						}
					}

		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Location Filter with ComboBox",
									"targetURL": "#sync04zfc0282-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync04zfc0282-display": {
								"semanticObject": "sync04zfc0282",
								"action": "display",
								"description": "Location Filter with ComboBox",
								"title": "Location Filter with ComboBox",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync04.zfc0282",
									"url": sap.ui.require.toUrl("sync04/zfc0282")
								}
							}
						}
					}

		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Update Entity",
									"targetURL": "#sync04zfc02120-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync04zfc02120-display": {
								"semanticObject": "sync04zfc02120",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync04.zfc02120",
									"url": sap.ui.require.toUrl("sync04/zfc02120")
								}
							}
						}
					}

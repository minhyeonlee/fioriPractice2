		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Filter",
									"targetURL": "#sync04zfc0280-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync04zfc0280-display": {
								"semanticObject": "sync04zfc0280",
								"action": "display",
								"description": "Filter",
								"title": "Filter",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync04.zfc0280",
									"url": sap.ui.require.toUrl("sync04/zfc0280")
								}
							}
						}
					}

		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Filter Prac 2",
									"targetURL": "#sync04zfc0281-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync04zfc0281-display": {
								"semanticObject": "sync04zfc0281",
								"action": "display",
								"description": "Filter Prac 2",
								"title": "Filter Prac 2",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync04.zfc0281",
									"url": sap.ui.require.toUrl("sync04/zfc0281")
								}
							}
						}
					}

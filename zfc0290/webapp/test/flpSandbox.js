		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAP Connection Prac",
									"targetURL": "#sync04zfc0290-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync04zfc0290-display": {
								"semanticObject": "sync04zfc0290",
								"action": "display",
								"description": "SAP Connection Prac",
								"title": "SAP Connection Prac",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync04.zfc0290",
									"url": sap.ui.require.toUrl("sync04/zfc0290")
								}
							}
						}
					}
